...
MainError errorsHandler(DioException error) {
  ...
  switch (errorCode) {
    case 400:
      return BadRequestError(message: apiErrorMessage);
    case 401:
      return UnauthError(message: apiErrorMessage);
    case 403:
      return ForbiddenError(message: apiErrorMessage);
    case 404:
      return NotFoundError(message: apiErrorMessage);
    case 500:
    case 510:
      return ServerError(message: apiErrorMessage);
    case 511:
      return ExpiredSessionError(message: apiErrorMessage);
    default:
